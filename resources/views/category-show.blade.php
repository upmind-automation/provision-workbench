...
@section('content')
    ...
    <div class="ui basic buttons">
        ...
        <a class="ui icon button" href="{{ route('provision-request-index', ['category_code' => $category->getIdentifier()]) }}">View Requests <i class="zoom-in icon"></i></a>
    </div>
    ...
    <div class="ui link cards">
        @foreach($category->getProviders() as $provider)
            <a class="ui fluid card" style="max-width:220px" href="{{ route('provider-show', ['category_code' => $category->getIdentifier(), 'provider_code' => $provider->getIdentifier()]) }}">
                <div class="image" style="height:110px; display:flex; justify-content: center; align-items: center; padding:0.5rem;">
