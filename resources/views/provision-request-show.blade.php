    ...
    <div class="provision-request-show">
        <div class="ui basic buttons">
            @if($provision_request->isSuccess())
                <a class="ui icon button" href="{{ route('provision-request-new', ['provision_request_id' => $provision_request->id, 'function_name' => '', 'use_result_data' => true]) }}">Next Request <i class="blue play circle icon"></i></a>
            @endif
